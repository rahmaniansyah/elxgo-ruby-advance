...
RSpec.describe Library do
    ...
    context '#search_books_by_title' do
        it 'return 010101: 9780747532743 | Harry Potter 1 | J. K. Rowling when input Harry Potter' do
            ...
            expect(first_library.search_books_by("title","Harry Potter")).to eq ["010101: 9780747532743 | Harry Potter 1 | J. K. Rowling"]
        end
        ...
        it 'return array of string when input books with the similiar title' do
            ...
            expect(first_library.search_books_by("title","Harry Potter")).to eq ["010101: 9780747532743 | Harry Potter 1 | J. K. Rowling", "010102: 9780807281918 | Harry Potter 2 | J. K. Rowling"]
        end

        it 'return Book not found! when input not exists' do
            first_library.put_book(isbn1,title1,author1)

            expect(first_library.search_books_by("title","Childern's life")).to eq "Book not found!"
        end
    end
    ...
    context '#search_books_by_author' do
        it 'return books when input existing author name' do
            ...
            expect(first_library.search_books_by("author","Kent Beck")).to eq ["010102: 9780201485677 | Refactoring | Martin Fowler, Kent Beck"]
        end
        ...
        it 'return array of string when input books with the similiar author name' do
            ...
            expect(first_library.search_books_by("author","Rowling")).to eq ["010101: 9780747532743 | Harry Potter 1 | J. K. Rowling", "010102: 9780807281918 | Harry Potter 2 | J. K. Rowling"]
        end

        it 'return Book not found! when input not exists' do
            first_library.put_book(isbn1,title1,author1)

            expect(first_library.search_books_by("author","rahma")).to eq "Book not found!"
        end
    end
end